...
import { Gift, CheckSquare, PlusCircle, Star } from "lucide-react";
...
const breakdownData = [
  { name: 'Hires', value: 3000, color: '#a78bfa' },
  { name: 'Feedback', value: 700, color: '#60a5fa' },
  { name: 'Job Posts', value: 500, color: '#34d399' },
  { name: 'Bonuses', value: 300, color: '#facc15' },
];

const recentRewards = [
    { title: "Candidate Hired", user: "Ayşe Yılmaz", tokens: 300, date: "1d ago", icon: Star },
    { title: "Interview Feedback", user: "David Chen", tokens: 35, date: "2d ago", icon: CheckSquare },
    { title: "Job Posted", user: "Senior Frontend Engineer", tokens: 50, date: "3d ago", icon: PlusCircle },
];
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
          <Card className="text-center flex flex-col justify-center items-center p-4">
              ...
              <p className="text-4xl font-bold text-primary animate-bounce">{recruiter.total_trust.toLocaleString()}</p>
          </Card>
                ...
                <div key={i} className="flex justify-between items-center p-2 bg-background rounded-lg border">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">{reward.user}</p>
                        </div>
                    </div>
